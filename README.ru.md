...
- Mac с чипом Apple (M1 и новее). Mac с процессором Intel не поддерживаются.
...
./build.sh         # release (arm64), подпись, установка в ~/Applications
...
- **Версии зависимостей закреплены осознанно** — не поднимайте их бездумным
  `swift package update`; почему — в [`CONTRIBUTING.ru.md`](CONTRIBUTING.ru.md).
