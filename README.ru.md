...
<p align="center">
  ...
  <img alt="Платформа" src="https://img.shields.io/badge/platform-macOS%2015%2B-lightgrey">
...
Чистая логика покрыта тестами: `swift test` прогоняет 531 проверку меньше чем за
