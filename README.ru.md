...
- **Xcode 26 или новее** для сборки из исходников. Сам пакет объявлен как
  `swift-tools-version: 5.9` и таргетит macOS 14, но одна из зависимостей требует
  Swift 6.2, а API Liquid Glass не скомпилируются без SDK macOS 26. Собранное
  приложение по-прежнему работает на macOS 14 — требование относится только к машине сборки.
